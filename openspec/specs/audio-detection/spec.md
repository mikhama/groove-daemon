...
## Purpose
Detect vinyl playback using environmental audio analysis from a USB microphone. This capability enables non-invasive playback monitoring without connecting to the turntable or audio chain.
## Requirements
